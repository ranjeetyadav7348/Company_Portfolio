  ...
  return (
   ...
   <div className="my-4 py-4">
      ...
      >
        ...
        <SwiperSlide>
          <div className="bg-white transition-all ease-in-out duration-100  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
            <div className="m-2 text-justify text-sm">
              <img
                ...
                src={img}
              />
              <h2 className="font-semibold my-1 text-2xl text-center">
                Web Development
              </h2>
        ...
        <SwiperSlide>
          <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
            <div className="m-2 text-justify text-sm">
              <img
                alt="card img"
                className="rounded-t group-hover:scale-[1.10] transition duration-1000 ease-in-out"
                src={img2}
              />
